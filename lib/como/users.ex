defmodule Como.Users do
  ...
  alias Como.Users.{User, UserToken, UserNotifier}
  alias Como.Tenants
  alias Como.Repo
    ...
    case get_user_by_email(email) do
      ...
      %User{} = user ->
        ...
        UserNotifier.deliver_login_link(
          user,
          "#{ComoWeb.Endpoint.url()}/signin/token/#{email_token}"
        )
        ...
        case register_user(%{email: email}) do
          {:ok, user} ->
            ...
            UserNotifier.deliver_register_link(
              user,
              "#{ComoWeb.Endpoint.url()}/signup/token/#{email_token}"
            )
