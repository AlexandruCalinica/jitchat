defmodule Como.ApiTokens.ApiToken do
  @moduledoc """
  ...
  def build_api_token(user, name, opts \\ []) do
    ...
    {encoded_token,
     %ApiToken{
       id: Como.Utils.IdGenerator.generate_id_21("api_token"),
       token: hashed_token,
       name: name,
       user_id: user.id,
       scopes: scopes,
  ...
  def touch_token(%ApiToken{} = api_token) do
    ...
    case Como.Repo.update(changeset) do
      {:ok, updated_token} ->
        {:ok, updated_token}
