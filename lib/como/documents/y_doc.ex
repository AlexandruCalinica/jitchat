defmodule Como.Documents.YDoc do
  @moduledoc """
  ...
  use Como.Documents.YEcto,
    repo: Como.Repo,
    schema: Como.Documents.DocumentWrite
end

defmodule Como.Documents.EctoPersistence do
  @moduledoc """
  ...
  def bind(_state, doc_name, doc) do
    ecto_doc = Como.Documents.YDoc.get_y_doc(doc_name)

    {:ok, new_updates} = Yex.encode_state_as_update(doc)
    Como.Documents.YDoc.insert_update(doc_name, new_updates)
  ...
  def update_v1(_state, update, doc_name, _doc) do
    Como.Documents.YDoc.insert_update(doc_name, update)
    :ok
  end
end
